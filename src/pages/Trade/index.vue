  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：<span>{{ currentAddress.consignee }}&nbsp;&nbsp;&nbsp;</span>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      tradeNo: (state) => state.trade.tradeNo || "",
    }),
    totalNum() {
      let { orderInfo } = this;
      let total = 0;
  ...
  methods: {
    changeDefault(id) {
      let { addressInfo } = this;
      addressInfo.forEach((item) => {
        item.isDefault = 0;
      });
      addressInfo[id - 1].isDefault = 1;
    },
    async submitOrder() {
      try {
        let { currentAddress, tradeNo, orderInfo, msg } = this;
        let data = {
          consignee: currentAddress.consignee,
          consigneeTel: currentAddress.phoneNum,
          deliveryAddress: currentAddress.fullAddress,
          paymentWay: "ONLINE",
          orderComment: msg,
